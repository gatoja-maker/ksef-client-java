...
public class ApiClient {
     ...
     */
    public void setRequestInterceptor(Consumer<HttpRequest.Builder> interceptor) {
     ...
     *                    of null resets the interceptor to a no-op.
     */
    public void setResponseInterceptor(Consumer<HttpResponse<InputStream>> interceptor) {
     ...
     *                    of null resets the interceptor to a no-op.
     */
    public void setAsyncResponseInterceptor(Consumer<HttpResponse<String>> interceptor) {
