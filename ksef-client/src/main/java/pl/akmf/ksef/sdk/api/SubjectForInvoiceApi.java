...
public class SubjectForInvoiceApi {
    ...
    /**
     * [mock] Pobranie listy uprawnień do obsługi faktur nadanych podmiotom
     *
     * @return ApiResponse&lt;Void&gt;
     * @throws ApiException if fails to make API call
     */
    public ApiResponse<Void> apiV2PermissionsEntitiesGrantsGet() throws ApiException {
        HttpRequest.Builder localVarRequestBuilder = apiV2PermissionsEntitiesGrantsGetRequestBuilder();
        try {
            ...
            try {
                if (localVarResponse.statusCode() / 100 != 2) {
                    throw getApiException("apiV2PermissionsEntitiesGrantsGet", localVarResponse);
                }
    ...
    private HttpRequest.Builder apiV2PermissionsEntitiesGrantsGetRequestBuilder() {

        HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

        String localVarPath = "/api/v2/permissions/entities/grants";
    ...
    public ApiResponse<PermissionsOperationResponse> apiV2PermissionsEntitiesGrantsPost(GrantEntityPermissionsRequest grantEntityPermissionsRequest) throws ApiException {
        ...
        try {
            ...
            if (localVarResponse.statusCode() / 100 != 2) {
                throw getApiException("apiV2PermissionsEntitiesGrantsPost", localVarResponse);
            }
            return new ApiResponse<>(
                    localVarResponse.statusCode(),
                    localVarResponse.headers().map(),
