...
import pl.akmf.ksef.sdk.api.ActiveSessionController__BeanDefinitions;
import pl.akmf.ksef.sdk.api.AuthController__BeanDefinitions;
import pl.akmf.ksef.sdk.api.BatchSessionController__BeanDefinitions;
import pl.akmf.ksef.sdk.api.CertificateController__BeanDefinitions;
import pl.akmf.ksef.sdk.api.EntityPermissionsController__BeanDefinitions;
import pl.akmf.ksef.sdk.api.EuEntityPermissionsController__BeanDefinitions;
import pl.akmf.ksef.sdk.api.EuEntityRepresentativePermissionsController__BeanDefinitions;
import pl.akmf.ksef.sdk.api.IndirectPermissionsEntityController__BeanDefinitions;
import pl.akmf.ksef.sdk.api.InvoicesController__BeanDefinitions;
import pl.akmf.ksef.sdk.api.OnlineSessionController__BeanDefinitions;
import pl.akmf.ksef.sdk.api.OperationStatusController__BeanDefinitions;
import pl.akmf.ksef.sdk.api.PersonPermissionController__BeanDefinitions;
import pl.akmf.ksef.sdk.api.ProxyPermissionsEntityController__BeanDefinitions;
import pl.akmf.ksef.sdk.api.PublicKeyController__BeanDefinitions;
import pl.akmf.ksef.sdk.api.QrCodeController__BeanDefinitions;
import pl.akmf.ksef.sdk.api.SearchPermissionTestEndpoint__BeanDefinitions;
import pl.akmf.ksef.sdk.api.SessionController__BeanDefinitions;
import pl.akmf.ksef.sdk.api.SubUnitPermissionsController__BeanDefinitions;
import pl.akmf.ksef.sdk.api.TokensController__BeanDefinitions;

/**
 * Register bean definitions for the bean factory.
 */
@Generated
public class TestClientApplication__BeanFactoryRegistrations {
  /**
  ...
  public void registerBeanDefinitions(DefaultListableBeanFactory beanFactory) {
    ...
    beanFactory.registerBeanDefinition("testClientApplication", TestClientApplication__BeanDefinitions.getTestClientApplicationBeanDefinition());
    beanFactory.registerBeanDefinition("jacksonConfig", JacksonConfig__BeanDefinitions.getJacksonConfigBeanDefinition());
    beanFactory.registerBeanDefinition("ksefClientConfig", KsefClientConfig__BeanDefinitions.getKsefClientConfigBeanDefinition());
    beanFactory.registerBeanDefinition("activeSessionController", ActiveSessionController__BeanDefinitions.getActiveSessionControllerBeanDefinition());
    beanFactory.registerBeanDefinition("authController", AuthController__BeanDefinitions.getAuthControllerBeanDefinition());
    beanFactory.registerBeanDefinition("batchSessionController", BatchSessionController__BeanDefinitions.getBatchSessionControllerBeanDefinition());
    beanFactory.registerBeanDefinition("certificateController", CertificateController__BeanDefinitions.getCertificateControllerBeanDefinition());
    beanFactory.registerBeanDefinition("entityPermissionsController", EntityPermissionsController__BeanDefinitions.getEntityPermissionsControllerBeanDefinition());
    beanFactory.registerBeanDefinition("euEntityPermissionsController", EuEntityPermissionsController__BeanDefinitions.getEuEntityPermissionsControllerBeanDefinition());
    beanFactory.registerBeanDefinition("euEntityRepresentativePermissionsController", EuEntityRepresentativePermissionsController__BeanDefinitions.getEuEntityRepresentativePermissionsControllerBeanDefinition());
    beanFactory.registerBeanDefinition("indirectPermissionsEntityController", IndirectPermissionsEntityController__BeanDefinitions.getIndirectPermissionsEntityControllerBeanDefinition());
    beanFactory.registerBeanDefinition("invoicesController", InvoicesController__BeanDefinitions.getInvoicesControllerBeanDefinition());
    beanFactory.registerBeanDefinition("onlineSessionController", OnlineSessionController__BeanDefinitions.getOnlineSessionControllerBeanDefinition());
    beanFactory.registerBeanDefinition("operationStatusController", OperationStatusController__BeanDefinitions.getOperationStatusControllerBeanDefinition());
    beanFactory.registerBeanDefinition("personPermissionController", PersonPermissionController__BeanDefinitions.getPersonPermissionControllerBeanDefinition());
    beanFactory.registerBeanDefinition("proxyPermissionsEntityController", ProxyPermissionsEntityController__BeanDefinitions.getProxyPermissionsEntityControllerBeanDefinition());
    beanFactory.registerBeanDefinition("publicKeyController", PublicKeyController__BeanDefinitions.getPublicKeyControllerBeanDefinition());
    beanFactory.registerBeanDefinition("qrCodeController", QrCodeController__BeanDefinitions.getQrCodeControllerBeanDefinition());
    beanFactory.registerBeanDefinition("searchPermissionTestEndpoint", SearchPermissionTestEndpoint__BeanDefinitions.getSearchPermissionTestEndpointBeanDefinition());
    beanFactory.registerBeanDefinition("sessionController", SessionController__BeanDefinitions.getSessionControllerBeanDefinition());
    beanFactory.registerBeanDefinition("subUnitPermissionsController", SubUnitPermissionsController__BeanDefinitions.getSubUnitPermissionsControllerBeanDefinition());
    beanFactory.registerBeanDefinition("tokensController", TokensController__BeanDefinitions.getTokensControllerBeanDefinition());
    beanFactory.registerBeanDefinition("jsonNullableModule", JacksonConfig__BeanDefinitions.getJsonNullableModuleBeanDefinition());
    beanFactory.registerBeanDefinition("init", KsefClientConfig__BeanDefinitions.getInitBeanDefinition());
